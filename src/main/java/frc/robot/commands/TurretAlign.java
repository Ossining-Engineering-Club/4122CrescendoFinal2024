...
public class TurretAlign extends Command {
    ...
    public TurretAlign(Drivetrain drive, Limelight limelight, double goalx, double goaly, DoubleSupplier stickx, DoubleSupplier sticky, DoubleSupplier stickyaw) {
        m_drive = drive;
    ...
    public void execute() {
        ...
        if (m_limelight.hasTarget()) {
            ...
            if (Math.abs(rotPos-rotGoal) < constants.kVisTurretToleranceRadians) {
                rotPos = rotGoal;
                m_done = true;
            }
